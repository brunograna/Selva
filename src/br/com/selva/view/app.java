...
public class app extends JFrame {
	...
	public app() {
		...
		btneb.setIcon(new ImageIcon(app.class.getResource("/br/com/selva/imagem/Eb.jpg")));
		...
		button_3.setIcon(new ImageIcon(app.class.getResource("/br/com/selva/imagem/ma.jpg")));
		...
		button_4.setIcon(new ImageIcon(app.class.getResource("/br/com/selva/imagem/aero.jpg")));
		...
		button_5.setIcon(new ImageIcon(app.class.getResource("/br/com/selva/imagem/feb.jpg")));
